...
<body>
	<div class="container">
		<label style="margin-top:30px;">You Will be Notified when a new car has added to portal</label>
	...
	<script>
		...
		websocket.onmessage=function processMessage(message){
			...
			if(jsonData.message!=null)
			{
				...
				row.innerHTML="<td>"+details[0]+"</td><td>"+details[1]+"</td><td>"+"Ready to book"+"</td>";
				alert(details[0]+" Ready to book");
			}
		}
	</script>
</body>
